export default {
  ...
  options: {
    ...
    pauseOnMeeting: "Pause during meetings/calls",
    pauseOnMeetingDesc: "Pause the timer when the microphone is in use (video calls, voice chats) and resume automatically afterwards.",
    pauseOnMedia: "Pause while media is playing",
    pauseOnMediaDesc: "Pause the timer when audio is playing (videos, music) and resume automatically afterwards.",
  ...
  about: {
    ...
    repoDesc: "Report issues and suggest features on GitHub. Stars welcome.",
    license: "License",
    licenseDesc: "Released under the MIT License. Free to use and modify.",
  },
}
